...
import { addChannel, renameChannel, removeChannel, setCurrentChannelId, setDefaultChannel } from './store/channelsSlice';
...
export { sendMessage, addNewChannel, deleteChannel, setChannelName };
